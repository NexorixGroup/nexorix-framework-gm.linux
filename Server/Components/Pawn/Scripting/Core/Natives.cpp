...
{
	PawnManager::Get()->core->logLn(LogLevel::Warning, "ConnectNPC() function is deprecated and will be removed in future. You must use nexorix's official NPC functions.");
